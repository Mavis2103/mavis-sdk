...
<Callout type="info">
  With updates to on-chain governance model of Cardano, staking rewards are only
  withdrawable if your wallet is delegated to a DRep (Delegated Representative).
  For more information about DReps and governance delegation, see the
  [Governance documentation](/documentation/deep-dives/governance).
</Callout>
