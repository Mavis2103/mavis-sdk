...
```typescript
import { drepIDToCredential } from "@mavis-sdk/lucid";
...
```typescript
import { Lucid, Blockfrost, drepIDToCredential } from "@mavis-sdk/lucid";
...
When you delegate your voting power, Mavis library creates a certificate
