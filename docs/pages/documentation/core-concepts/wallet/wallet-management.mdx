...
This section covers everything you need to know about creating, selecting, and querying wallets using the Mavis library:
...
```typescript
import { generatePrivateKey } from "@mavis-sdk/lucid";
...
```typescript
import { generateSeedPhrase } from "@mavis-sdk/lucid";
