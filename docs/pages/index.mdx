...
<Bleed full>
  <ResponsiveContainer>
    <AnimatedCode 
      ...
      code={`import { Lucid, Koios, generateSeedPhrase } from "@mavis-sdk/lucid";
...
Why <span style={{ color: '#8b0000' }}>Mavis</span>?
</h2>

<FAQBox title="Improved APIs">
  Our interfaces are enhanced for better developer experience and function calls
  streamlined for common operations. Through the Mavis library, you take
...
<FAQBox title="Latest CML">
  We are keeping up with the latest version of the [Cardano Multi-platform Library (CML)](https://dcspark.github.io/cardano-multiplatform-lib/).
</FAQBox>
...
<FAQBox title="Developer-Centric">
  ...
  You can get support for your questions through our dedicated [Discord](https://discord.gg/s89P9gpEff) channel.
</FAQBox>
...
<Cards>
  <Cards.Card title="Mavis SDK packages" href="/install" />
</Cards>
...
<Steps>
<span style={{color: '#AD1F1E'}}>→</span> <span style={{color: '#AD1F1E'}}>**Instantiate**</span> Mavis SDK and choose a provider
<Cards>
  <Cards.Card
...
<Cards>
  <Cards.Card
    ...
    href="/documentation/core-concepts/wallet-management"
  />
</Cards>

<span style={{color: '#AD1F1E'}}>→</span>  <span style={{color: '#AD1F1E'}}>**Build**</span> your first transaction and submit it
...
<Cards>
  <Cards.Card
    ...
    href = "/documentation/deep-dives/pay-methods"
  />
</Cards>
</Steps>
</Steps>
...
# See <span style={{color: '#AD1F1E'}}>Mavis</span> in motion
...
<div align="center">
  <iframe
    width="100%"
    height="430"
    src="https://www.youtube.com/embed/aCV7XzyMUNw"
    title="Mavis SDK Introduction"
    frameborder="0"
...
<FAQBox title="What is Mavis SDK?">
  Mavis SDK is an off-chain framework library for Cardano, designed to
...
<FAQBox title="How does Mavis SDK ensure compatibility with Cardano's evolving scene?">
...
<FAQBox title="Can I contribute to the development?">
  Yes, of course! Contributions to Mavis SDK are welcome. You have an
...
<FAQBox title="How can I get help?">
  ...
  our team. We also have a dedicated channel for Mavis SDK where you can
